...
void iloczynatbt(float **a,float **b,float **c,long a1,long a2,long b1,long b2);//c=a*b', a(a1,a2), b(b1,b2), c(a1,b1), warunek konieczny a2=b2
void iloczynabt (float **a,float **b,float **c,long a1,long a2,long b1,long b2);//b=a*w, a(a1,a2), w(w1), b(a1), warunek konieczny a2=w1
void iloczynaw  (float **a,float * w,float * b,long a1,long a2,long w1);//wc=wa+wb gdy suma=1 lub wc=wa-wb gdy suma=-1
...
void iloczynwwt (float *wa,float *wb,float**wc,long w1,long w2);//wc=wa*wb', wa(w1), wb(w2), wc(w1,w2)
...
// void iloczynw(float *a,float b,float *c,long w1); -- nie istnieje taka funkcja
