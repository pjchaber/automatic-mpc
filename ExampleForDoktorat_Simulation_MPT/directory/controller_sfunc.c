...
/* Generated on 02-Jun-2018 18:49:43 by MPT 3.1.8 */ 

#define S_FUNCTION_NAME  controller_sfunc   /*Name of the S-function file*/
#define S_FUNCTION_LEVEL 2		/*Level 2 S-functions allow multi-port status*/
#define MPT_TS 0.200000		/* sample time */
#include "simstruc.h"			/*Header where different routines are defined */

#include "controller.c" /*inclusion of the evalution algorithm */
