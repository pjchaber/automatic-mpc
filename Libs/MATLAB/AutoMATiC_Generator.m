classdef AutoMATiC_Generator < handle
    properties (Constant)
    ...
    methods
        function obj = AutoMATiC_Generator(toexecute,tree) 
        ...
        function code = indentCode(obj,code)
            if(isempty(code))
                return;
            end
        ...
        function code = generateDeclarations(obj,variables,constants,matrices)
            ...
            if(isfield(obj.qpconf,'Hid'))
                ...
                qpcode = [...
                    sprintf('ustawilogr(%d);',Aidsize(1)),...
                    newline,...
                    sprintf('ustawilzm(%d);',Aidsize(2)),...
                    newline,...
                    'inicjalizacjapk();',...
                    newline,...
                    sprintf('%s=pobierzA();',obj.qpconf.Aid),...
                    newline,...
                    sprintf('%s=pobierzG();',obj.qpconf.Hid),...
                    newline,...
                    sprintf('%s=pobierzb();',obj.qpconf.bid),...
                    newline,...
                    sprintf('%s=pobierzt();',obj.qpconf.fid),...
                    newline,...
                    sprintf('%s=pobierzx();',obj.qpconf.xid),...
                    newline,...
                ];
...
%             elseif(node == 'CONDITION') % abandonned
%                 code = obj.generateCondition(node); 
...
%             elseif(node == 'COMPARISON') % abandonned
%                 code = obj.generateComparison(node); 
        ...
        function code = generateQuadprogAssignment(obj,node)
            ...
            code = [
                %sprintf('iloczyna(%s,-1,%s,%d,%d);',obj.qpconf.Aid,obj.qpconf.Aid,Aidsize(1),Aidsize(2)),...
                sprintf('iloczynw(%s,-1,%s,%d);',obj.qpconf.bid,obj.qpconf.bid,Aidsize(1)),...
                'pk();', ...
                newline,...
            ];            
        end        
