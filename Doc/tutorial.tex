...
\centering
\plotthissiet{dmca}
\caption{Control and output signals trajectories -- control using generated Analytic DMC controller}
\label{fig:dmca}
\end{figure}
A plot of signals measurements obtained from this controller is shown in the Fig. \ref{fig:dmca}. Also the result generated with a profiler is shown in table \ref{tab:dmca}. Consecutive columns in this and further shown tables are as follows:
\begin{itemize}
\item id-- identifier of the block of code, which was to be inspected,
\item time total-- total time that the program spent executing this block,
\item entries-- number of times the program entered this block,
\item min-- minimum amount of time spent executing this block,
\item mean--mean amount of time spent executing this block,
\item max--maximum amount of time spent executing this block,
\item running -- flag denoting if this data was obtained during execution of this block (1 -- yes, 0 -- no).
\end{itemize}
...
\begin{table}
\centering
\caption{Profiler results -- control using generated Analytic DMC controller}
\label{tab:dmca}
...
\centering
\plotthissiet{dmcn}
\caption{Control and output signals trajectories -- control using generated Numeric DMC controller}
\label{fig:dmcn}
\end{figure}
...
\begin{table}
\centering
\caption{Profiler results --  control using generated Numeric DMC controller}
\label{tab:dmcn}
\begin{tabular}{ccccccc}
	  id    & time total  & entries & min  & mean & max & running \\ \hline
	1 ( 1)  &       1        &    1    &    1    & 1.0000  &   1    &    0    \\
...
\centering
\plotthissiet{gpca}
\caption{Control and output signals trajectories -- control using generated Analytic GPC controller}
\label{fig:gpca}
\end{figure}
...
\begin{table}
\centering
\caption{Profiler results -- control using generated Analytic GPC controller}
\label{tab:gpca}
\begin{tabular}{ccccccc}
	  id    & time total  & entries & min  & mean & max & running \\ \hline
	1 ( 1)  &       1        &    1    &    1    & 1.0000  &   1    &    0    \\
...
\centering
\plotthissiet{gpcn}
\caption{Control and output signals trajectories -- control using generated Numeric GPC controller}
\label{fig:gpcn}
\end{figure}
...
\begin{table}
\centering
\caption{Profiler results -- control using generated Numeric GPC controller}
\label{tab:gpcn}
\begin{tabular}{ccccccc}
	  id    & time total  & entries & min  & mean & max & running \\ \hline
	1 ( 1)  &       1        &    1    &    1    & 1.0000  &   1    &    0    \\
...
\end{groupplot}
\end{tikzpicture}%
\caption{Control and output signals trajectories -- control using generated Numeric and Analytic DMC controllers}
\label{fig:dmcan}
\end{figure}
...
\begin{table}
\centering
\caption{Profiler results -- control using generated Numeric and Analytic DMC controllers}
\label{tab:dmcan}
\begin{tabular}{ccccccc}
	  id    & time total [s] & entries & min [s] & mean[s] & max[s] & running \\ \hline
	1 ( 1)  &       1        &    1    &    1    & 1.0000  &   1    &    0    \\
	2 ( 2)  &       0        &    1    &    0    & 0.0000  &   0    &    0    \\
	3 ( 3)  &       0        &   511   &    0    & 0.0000  &   0    &    0    \\
	4 ( 4)  &       29       &   511   &    0    & 0.0567  &   1    &    0    \\
...
\centering
\plotthissiet{pid}
\caption{Control and output signals trajectories -- control using generated PID controller}
\label{fig:pid}
\end{figure}
